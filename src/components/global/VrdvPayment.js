...
import { View, SafeAreaView, StyleSheet, TextInput, Animated, useColorScheme } from 'react-native';
import { colors } from './colors'
import Icon from 'react-native-vector-icons/Entypo';

const FloatingLabelInput = ({ label, value, onChangeText, width , keyboardType, maxLength, ...rest }) => {
    ...
    return (
        <View style={[styles.container, { width: width }]}>
            <Animated.Text onPress={handleLabelPress} style={[labelStyle, styles.label, { backgroundColor }]}>{label}</Animated.Text>
            <TextInput
                ref={inputRef}
                style={styles.input}
                value={value}
