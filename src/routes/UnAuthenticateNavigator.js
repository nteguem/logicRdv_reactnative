...
const UnauthenticatedNavigator = () => {
  return (
    <Stack.Navigator initialRouteName="Home">
      ...
      <Stack.Screen name="Message" options={pageOption} component={Paiement} initialParams={{ left: HeaderIcons.GO_BACK, right: HeaderIcons.ACCOUNT  }} />
      ...
      <Stack.Screen name="Liste des patients" options={pageOption} component={Paiement} initialParams={{ left: HeaderIcons.GO_BACK, right: HeaderIcons.ACCOUNT  }} />
